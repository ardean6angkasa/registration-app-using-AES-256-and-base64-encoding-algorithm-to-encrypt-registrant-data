            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" style="color:#f1c101" href="<?= base_url('/useracc/information'); ?>">Information</a></li> 
                    </ul>
                </div>
            </div>
        </nav>
...
<?php if(empty($help_info)):?>
     ...
     data-aos-duration="4000">
          ...
          <div class="small text-muted">Posted on <?= date('F d, Y', $row['date_created']);?> by <b style="color:#ffb900"><?= $row['author']; ?></b></div>
            ...
            <a href="<?= base_url('/read/index5/' . $row['id']); ?>" class="btn btn-outline-dark rounded-pill">Read More →</a>
          </div>
          </div>
     ...
     data-aos-duration="4000">
          ...
          <?= csrf_field();?>
            ...
            <input type="text" class="form-control" placeholder="(Search keyword: category or title)" name="keyword" value="<?= session()->get('keyword10')?>" autocomplete="off">
