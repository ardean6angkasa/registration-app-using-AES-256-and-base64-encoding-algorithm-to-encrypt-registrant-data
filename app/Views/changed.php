...
<div class="preloader bg-light" id="preloader" align="center">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h6 class="mb-4" style="color:black"><?= session()->get('reset_password') ?></h6>
                                    </div>
            ...
            <label for="InputForPassword" class="form-label" style="color:black">New Password</label>
            ...
            <label for="InputForConfPassword" class="form-label" style="color:black">Re-type New Password</label>
                        <div class="invalid-feedback">
            <?php if(isset($validation)):?>
            ...
            <?php endif;?>
                    ...
                    <div class="container" style="color:black">
                            <input type="checkbox" onclick="myFunction()" class="form-check-input"> Show Password
                            </div>
                        <hr>
                            <div align ="right">
