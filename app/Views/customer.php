...
<hr class="sidebar-divider d-none d-md-block" style="color:white">
    ...
    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                    ...
                    <form action="<?= base_url('/serve'); ?>" method="post"
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <?= csrf_field();?>
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="(Search keyword: email or role)"
                                aria-label="Search" aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword1')?>" autocomplete="off" autofocus>
        ...
        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                                ...
                                <form class="form-inline mr-auto w-100 navbar-search" action="/serve" method="post">
                                <?= csrf_field();?>
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small"
                                            placeholder="(Search keyword: email or role)" aria-label="Search"
                                            aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword1')?>" autocomplete="off">
                                        <div class="input-group-append">
                                        <button class="btn btn-outline-dark" type="submit" name="search">
                                                <i class="fas fa-search fa-sm"></i>
                                            </button>
...
<h1 class="h3 mb-2 text-gray-800">Help & Report</h1>
    ...
    <button type="button" class="btn btn-success mb-2"><i class="fas fa-file-download fa-lg"></i></button>
        ...
        <table class="table table-hover table-dark table-sm">
            ...
            <tbody>
                ...
                <tr align="center">
                <td scope="row"><?= $i++; ?></td>
                    <td><?= $encrypter->decrypt(base64_decode($row['name']));?></td>   
                    <td><?= $row['email'];?></td>
...
<?php if(empty($customer_service)):?>
        ...
        <div class="alert alert-dark alert-dismissible d-flex align-items-center fade show" role="alert">
            ...
            <?= $pager->links('customer_service', 'default_full');?>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal-content">
    ...
    <?php foreach($customer_service as $row):$row['id']; ?>
    <form action="<?= base_url('/serve/delete') ?>" method="post">
    ...
    <div class="modal fade" id="deleteModal<?= $row['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
               <p style="color:black">Are you sure, you want to delete the message from <?= $row['email'];?> permanently?</p>
            </div>
            <div class="modal-footer">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="<?= base_url('/sendmsg/send5'); ?>" method="POST" enctype="multipart/form-data">
    <?= csrf_field();?>
...
<label class="custom-file-label text-preview4" for="file4" style="color:black">Send a certificate (only for a registered account)</label>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="<?= base_url('/serve/registration'); ?>" method="POST">
    <?= csrf_field();?>
    <div class="form-floating mb-3">
...
<div class="modal fade" id="commitDelete" aria-hidden="true" aria-labelledby="exampleDelete" tabindex="-1" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
                                    <form action="<?= base_url('/serve/delete2'); ?>" method="post">
    <?= csrf_field();?>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="<?= base_url('/profile/editprofile5'); ?>" enctype="multipart/form-data" method="POST">
    <?= csrf_field();?>
    <input type="hidden" name="user_id" value="<?= session()->get('user_id')?>"> 
    <div class="form-group" align="center">
...
<div class="modal fade" id="removePict" aria-hidden="true" aria-labelledby="removePicture" tabindex="-1" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?= base_url('/removephoto/remove5'); ?>" method="POST">
...
<div class="modal fade" id="exampleModalToggle3" aria-hidden="true" aria-labelledby="exampleModalToggleLabel3" tabindex="-1" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="<?= base_url('/editpass/password5'); ?>" method="POST">
    <?= csrf_field();?>
    <input type="hidden" name="user_id" value="<?= session()->get('user_id')?>">  
    <div class="form-floating mb-3">
              <input type="password" class="form-control <?php if(isset($validation)):?>
