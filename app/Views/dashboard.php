...
<body id="page-top">
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      ...
      <h1 class="mb-1" style="color: #FFB900" data-aos="flip-down" data-aos-easing="linear" data-aos-duration="4000">
        SIPS</h1>

      <h3 class="mb-5" style="color: #FFB900" data-aos="flip-down" data-aos-easing="linear" data-aos-duration="4000">
      ...
      <a class="btn btn-outline-warning btn-xl js-scroll-trigger rounded-pill" href="#register" data-aos="fade-down"
        data-aos-easing="linear" data-aos-duration="2000">Registrasi Sekarang</a>
    </div>
  ...
  <section class="content-section bg-warning text-black" id="help_center">
    <div class="container">
      <div class="text-center my-5">
        <h1 class="section-heading fw-bolder" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="4000"
          style="color:white">Help Center & Information</h1>
      </div>
    </div>
          ...
          <?php foreach ($help_info as $row): ?>
            <div class="card mb-4" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="4000">
              ...
              <div class="card-body">
                ...
                <a href="<?= base_url('/read/index4/' . $row['id']); ?>" class="btn btn-outline-dark rounded-pill">Read
                  More →</a>
              </div>
            </div>
            ...
            <div class="card-body">
              <form action="<?= base_url('/login'); ?>" method="post">
                <div class="input-group">
                  <?= csrf_field(); ?>
                  <input type="text" class="form-control" placeholder="(Search keyword: category or title)"
                    name="keyword" value="<?= session()->get('keyword2') ?>" autocomplete="off">
  ...
  <section class="content-section bg-dark" id="register">
    <div class="container">
      ...
      <h2 class="mx-auto mb-5" align="center" data-aos="fade-down" data-aos-duration="4000" data-aos-easing="linear"
        style="color:white">
      ...
      <div align="center">
        <div class="row align-items-stretch mb-5">
          <div class="col-md-6">
            <button type="button" class="btn btn-outline-light mb-2 rounded-pill btn-xl" data-toggle="modal"
              data-target="#addModal" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="2000">Test of
              English for International Communication</button>
          </div>
          <div class="col-md-6">
            <button type="button" class="btn btn-outline-light mb-2 rounded-pill btn-xl" data-toggle="modal"
              data-target="#addModal2" data-aos="fade-down" data-aos-easing="linear"
      ...
      <?php endif; ?>" onchange="previewImg2()">
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-outline-dark rounded-pill"><i class="fas fa-paper-plane fa-lg"></i>
                Submit</button>
              </form>
            </div>
          </div>
      ...
      <div class="modal fade" id="addModal2" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true"
        data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel2">Pendaftaran Pelatihan Persiapan atau Ujian Sertifikasi
                Lainnya</h5>
              <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
      ...
      <?php endif; ?>" onchange="previewImg3()">
                      ...
                      <label class="custom-file-label text-preview3" for="file3">
                        <p>Struk Pembayaran Anda</p>
                      </label>
                    </div>
                  </div>
                  <div class="form-floating mb-3">
  ...
  <section class="content-section bg-light" id="signin">
    <div class="container">
      <div class="content-section-heading text-center" data-aos="flip-down" data-aos-duration="4000"
        ...
        <div class="col-lg-6">
          <div class="portfolio-item" data-aos="fade-down" data-aos-duration="4000" data-aos-easing="linear">
            <a class="portfolio-link" data-toggle="modal" href="#" data-target="#portfolioModal">
              ...
              <div class="caption">
                <div class="caption-content" align="center" data-aos="zoom-out-down" data-aos-duration="4000"
                  data-aos-easing="linear">
  ...
  <section class="content-section bg-primary text-white" id="contact" align="center"
    style="background-image: url('/img/mapimage.png');">
    <div class="col-lg-8 mx-auto">
      <div class="container">

        <div class="text-center" data-aos="flip-left" data-aos-easing="linear" data-aos-duration="4000">
        ...
        <form action="<?= base_url('/serve/save'); ?>" method="POST">
          <?= csrf_field(); ?>
          <div class="row align-items-stretch mb-5" data-aos="flip-left" data-aos-easing="linear"
            ...
            <div class="text-center">
              ...
              <button class="btn btn-outline-light rounded-pill btn-xl" type="submit" data-aos="fade-down"
                data-aos-easing="linear" data-aos-duration="2000"><i class="fas fa-paper-plane fa-lg"></i> Send
                Message</button>
        </form>
      </div>
    </div>
  ...
  <!-- Map -->
  <div class="map" data-aos="fade-down" data-aos-duration="4000" data-aos-easing="linear">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.781438310159!2d106.72326231476957!3d-6.292430295445794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f007dedc7de1%3A0x70288cde58f42a97!2sUniversitas%20Pembangunan%20Jaya!5e0!3m2!1sen!2sid!4v1620091574130!5m2!1sen!2sid"></iframe>
    <br>
    <small>
      <a
        href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.781438310159!2d106.72326231476957!3d-6.292430295445794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f007dedc7de1%3A0x70288cde58f42a97!2sUniversitas%20Pembangunan%20Jaya!5e0!3m2!1sen!2sid!4v1620091574130!5m2!1sen!2sid"></a>
    </small>
  </div>

  <!-- Footer -->
  <footer class="footer text-center bg-light" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="2000">
    <div class="container">
      <ul class="list-inline mb-5">
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white mr-3" href="https://www.facebook.com/jcal.upj.9"><i
              class="fab fa-facebook-f"></i></a>
        </li>
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white mr-3" href="https://twitter.com/upj_bintaro"><i
              class="fab fa-twitter"></i></a>
        </li>
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white" href="https://www.instagram.com/jcal.upj"><i
  ...
  <div class="modal fade" id="portfolioModal" tabindex="-1" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
    data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <img class="img-fluid d-block mx-auto" data-tilt data-tilt-max="26" data-tilt-speed="4000"
            data-tilt-scale="1.2" src="/img/logo1.png" />
        ...
        <div class="modal-footer">
          <div>
            <button type="submit" class="btn btn-outline-primary rounded-pill"><i class="fas fa-sign-in-alt"></i> Sign
              In</button>
            </form>
          </div>
          ...
          <div>
            <button class="btn btn-outline-primary rounded-pill" data-target="#exampleModalToggle2" data-toggle="modal"
              data-dismiss="modal">Forgot Your Password?</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalToggleLabel2">Fill out your email address, you'll receive instructions
        ...
        <div class="modal-footer">
          ...
          <div>
            <button class="btn btn-outline-primary rounded-pill" data-target="#portfolioModal" data-toggle="modal"
              data-dismiss="modal">Back To Sign In</button>
          </div>
        </div>
      </div>
    </div>
