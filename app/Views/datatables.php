...
<body id="page-top">
        ...
        <form action="<?= base_url('/modalboot'); ?>" method="post"
          ...
          <div class="input-group">
            <input type="text" class="form-control bg-light border-0 small" placeholder="(Search keyword: email)"
              ...
              value="<?= session()->get('keyword3') ?>" autocomplete="off" autofocus>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
              ...
              <form class="form-inline mr-auto w-100 navbar-search" action="/modalboot" method="post">
                ...
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0 small" placeholder="(Search keyword: email)"
                    aria-label="Search" aria-describedby="basic-addon2" name="keyword"
                    value="<?= session()->get('keyword3') ?>" autocomplete="off">
          ...
          <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
              ...
              <a class="dropdown-item" type='button' href="#" data-toggle="modal" data-target="#editSettings">
              ...
              <table class="table table-hover table-dark table-sm">
                ...
                <tbody>
                  ...
                  <?php foreach ($formulir_pendaftaran as $row): ?>
                    <tr align="center">
                      <td scope="row"><?= $i++; ?></td>
                      <td><img class="img-responsive img-thumbnail" src="/pasfoto/<?= $row['pas_foto']; ?>"
                          style="width:40%"></td>
                      ...
                      <td><?= (date('d-n-Y', strtotime($encrypter->decrypt(base64_decode($row['tanggal_lahir']))))); ?>
                      </td>
                      <td><?= $encrypter->decrypt(base64_decode($row['nomor_telepon'])); ?></td>
                      <td><?= $row['email']; ?></td>

                      <td>
                        <a href="#" class="btn btn-warning btn-sm" data-target="#viewModal<?= $row['product_id']; ?>"
                          data-toggle="modal"><i class="fas fa-external-link-alt"></i></a><br><br>
                        <a href="#" class="btn btn-info btn-sm" data-target="#editModal<?= $row['product_id']; ?>"
                          data-toggle="modal"><i class="fas fa-edit d-inline"></i></a><br><br>
                        <a href="#" class="btn btn-danger btn-sm" data-target="#deleteModal<?= $row['product_id']; ?>"
  ...
  <?php foreach ($formulir_pendaftaran as $row):
    ...
    <form action="<?= base_url('/modalboot/update'); ?>" method="post">
      <div class="modal fade" id="editModal<?= $row['product_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel2"
        ...
        <div class="modal-dialog modal-lg">
          ...
          <?php endif; ?>" name="id_number"
            ...
            <?php endif; ?>" name="program_studi2" placeholder=""
                      value='<?= (old('program_studi2')) ? old('program_studi2') : $encrypter->decrypt(base64_decode($row['program_studi'])); ?>'>
            ...
            <?php endif; ?>" name="tanggal_lahir"
                      value='<?= (old('tanggal_lahir')) ? old('tanggal_lahir') : $encrypter->decrypt(base64_decode($row['tanggal_lahir'])); ?>'>
            ...
            <?php endif; ?>" name="nomor_telepon2" placeholder=""
                      value='<?= (old('nomor_telepon2')) ? old('nomor_telepon2') : $encrypter->decrypt(base64_decode($row['nomor_telepon'])); ?>'>
                  ...
                  <div class="form-floating mb-3">
                    <input type="email" style="color:black" class="form-control" name="mail" value='<?= $row['email']; ?>'
                      readonly>
  ...
  <?php foreach ($formulir_pendaftaran as $row):
    $row['product_id']; ?>
    <div class="modal fade" id="viewModal<?= $row['product_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel2"
      aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <p class="card-text" style="color:black">
                          ...
                          Tanggal Lahir:
                          <?= (date('d - F - Y', strtotime($encrypter->decrypt(base64_decode($row['tanggal_lahir']))))); ?><br>
                          Email: <?= $row['email']; ?><br>
  ...
  <?php foreach ($formulir_pendaftaran as $row):
    ...
    <form action="<?= base_url('/modalboot/delete'); ?>" method="post">
      <div class="modal fade" id="deleteModal<?= $row['product_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel3"
        aria-hidden="true" data-backdrop="static" data-keyboard="false">
