                    ...
                    <form action="<?= base_url('/read/form2'); ?>" method="post" class="col-sm-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light small searching"
                                ...
                                aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword02') ?>"
                                    ...
                                    <div class="card mb-3" style="max-width: 540px;">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" style="color:black" align='left'>
                                                Nomor identitas:
                                                <?= $encrypter->decrypt(base64_decode($row['id_number'])); ?><br>
                                                ...
                                                Email: <?= $row['email']; ?><br>
                                                Nomor Telepon:
                                                <?= $encrypter->decrypt(base64_decode($row['telepon'])); ?><br>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card mb-3" style="max-width: 540px;">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title" style="color:black" align='left'>Bukti Pembayaran
                                                    </h5>
                                                    <p class="card-text" style="color:black" align='left'>Nama di Rekening:
                                                        <?= $encrypter->decrypt(base64_decode($row['account'])); ?><br>
                                                        Nama Bank Pentransfer:
                                                        <?= $encrypter->decrypt(base64_decode($row['bank_name'])); ?><br>
                                                        Tanggal Transfer:
                                                        <?= (date('d - F - Y', strtotime($encrypter->decrypt(base64_decode($row['transaction']))))); ?><br>
                                                        Jumlah Transfer:
                                                        <?= $encrypter->decrypt(base64_decode($row['nominal'])); ?><br>
                                                        Keterangan: <?= $row['inform']; ?></p>
                                                    <p class="card-text" align='left'><small class="text-muted">Submitted
                                                            at: <?= date('F d, Y', $row['created']); ?></small></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
