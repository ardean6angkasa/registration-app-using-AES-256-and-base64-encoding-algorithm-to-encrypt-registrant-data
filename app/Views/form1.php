  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid px-4">
        ...
        <h1 align="center"><b>Data Pendaftar TOEIC</b></h1>
        <div align='right'>
          <form action="<?= base_url('/read/formpdf'); ?>" method="post" class="col-sm-4">
            <?= csrf_field(); ?>
            <div class="input-group">
              <input type="text" class="form-control bg-light small searching" placeholder="(Search keyword: email)"
                aria-label="Search" aria-describedby="basic-addon2" name="keyword"
                value="<?= session()->get('keyword01') ?>" autocomplete="off" autofocus>
              ...
              <div class="row align-items-stretch mb-5">
                  ...
                  <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                      ...
                      <div class="col-md-8">
                        <div class="card-body">
                          No. <?= $i++; ?>
                          <h5 class="card-title" style="color:black" align='left'> Biodata</h5>
                ...
                <div class="col-md-6">
                  <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="/receipt/<?= $row['struk']; ?>" class="img-fluid rounded-start img-responsive">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title" style="color:black" align='left'>Bukti Pembayaran</h5>
                          <p class="card-text" style="color:black" align='left'>Nama di Rekening:
                            <?= $encrypter->decrypt(base64_decode($row['account'])); ?><br>
                            Nama Bank Pentransfer: <?= $encrypter->decrypt(base64_decode($row['bank_name'])); ?><br>
                            Tanggal Transfer:
                            <?= (date('d - F - Y', strtotime($encrypter->decrypt(base64_decode($row['transaction']))))); ?><br>
                            Jumlah Transfer: <?= $encrypter->decrypt(base64_decode($row['nominal'])); ?></p>
                          <p class="card-text" align='left'><small class="text-muted">Submitted at:
                              <?= date('F d, Y', $row['created']); ?></small></p>
                        </div>
                      </div>
                    </div>
                  </div>
