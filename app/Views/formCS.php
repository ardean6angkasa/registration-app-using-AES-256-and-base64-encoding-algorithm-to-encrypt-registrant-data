    ...
    <h6 class='steps'>
		...
		<form action="<?= base_url('/read/form3'); ?>" method="post" class="col-sm-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light small searching" placeholder="(Search keyword: email or role)"
                                aria-label="Search" aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword03')?>" autocomplete="off" autofocus>
        ...
        <table class="table table-hover table-dark table-sm">
            ...
            <tbody>
                ...
                <td scope="row"><?= $i++; ?></td>
                    ...
                    <td><?= $row['status'];?></td>
                    <td><?= date('F d, Y', $row['date_created']); ?> at <?= date('h:i A', $row['date_created']); ?></td>
                </tr>
            <?php endforeach;?>
            </tbody>
            </table>
