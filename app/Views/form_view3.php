...
<div class="preloader bg-light" id="preloader" align="center">
    ...
    <div class="container mt-5">
        ...
        <button class="btn btn-outline-primary border-0 rounded-pill" data-toggle="modal" data-target="#addModal" type="button">
     ...
     <img src="/picture/<?= $help_info['image']; ?>" class='img-thumbnail img-preview' style='width:24%'>
  <br>  <br>
...
<label class="custom-file-label" for="file"  style="color:black"><?= $help_info['image']; ?></label>
      </div>
      </div>    
      <div class="form-floating mb-3">   
                    <input type="text" style="color:black" class="form-control <?php if(isset($validation)):?>
            <?= ($validation->hasError('title2'))?'is-invalid' : ''; ?>
            <?php endif;?>" name="title2" value="<?= (old('title2')) ? old('title2') : $help_info['title']; ?>" placeholder="">
            ...
            <?php endif;?>
                ...
                <?php endif;?>
                    <input id="inf" type="hidden" name="information" value="<?= (old('information')) ? old('information') : $encrypter->decrypt(base64_decode($help_info['information'])); ?>">
                ...
                <div class="form-floating mb-3"> 
          <input type="text" class="form-control" name="auth" value="<?= $help_info['author']; ?>" readonly>
          <label style="color:black">Author</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-danger rounded-pill" data-toggle="modal" data-dismiss="modal" data-target="#deleteModal"><i class="fas fa-trash-alt d-inline"></i> Delete</button>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
               ...
               <input type="text" style="color:black" class="form-control" value="<?= $help_info['title']; ?>" readonly>
               
            </div>
            <div class="modal-footer">
                <input type="hidden" name="id" value="<?= $help_info['id']; ?>">
                <button class="btn btn-outline-dark rounded-pill" data-target="#addModal" data-toggle="modal" data-dismiss="modal">No</button>
