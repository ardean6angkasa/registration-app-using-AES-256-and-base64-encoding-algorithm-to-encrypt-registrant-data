...
<body id="page-top">
        ...
        <form action="<?= base_url('/activation'); ?>" method="post"
          ...
          <div class="input-group">
            <input type="text" class="form-control bg-light border-0 small" placeholder="(Search keyword: email)"
              ...
              value="<?= session()->get('keyword4') ?>" autocomplete="off" autofocus>
            ...
            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
              ...
              <form class="form-inline mr-auto w-100 navbar-search" action="/activation" method="post">
                ...
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0 small" placeholder="(Search keyword: email)"
                    aria-label="Search" aria-describedby="basic-addon2" name="keyword"
                    value="<?= session()->get('keyword4') ?>" autocomplete="off">
                  <div class="input-group-append">
                    <button class="btn btn-outline-dark" type="submit" name="search">
                      <i class="fas fa-search fa-sm"></i>
                    </button>
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            ...
            <h6 class="m-0 font-weight-bold text-primary">You can activate and deactivate accounts through this menu
            </h6>
          </div>
          <div class="card-body">
            <div align="center">
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="color:black">
                        ...
                        <div align='center'>
                          <a href="#" class="btn btn-success btn-md btn-activate rounded-pill"
                            data-id="<?= $row['user_id']; ?>" data-mail='<?= $row["email"]; ?>'
                            data-role='<?= $row["status"]; ?>'><i class="fas fa-toggle-on"></i>
                          </a>
                        </div>
                      <?php else: ?>
                        <div align='center'>
                          <a href="#" class="btn btn-danger btn-md btn-deactivate rounded-pill"
                            data-id="<?= $row['user_id']; ?>" data-mail='<?= $row["email"]; ?>'
  ...
  <form action="<?= base_url('/activation/deactivate'); ?>" method="post">
    ...
    <div class="modal fade" id="deactivateModal" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true"
      data-backdrop="static" data-keyboard="false">
  ...
  <form action="<?= base_url('/activation/activate'); ?>" method="post">
    ...
    <div class="modal fade" id="activateModal" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true"
      data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
