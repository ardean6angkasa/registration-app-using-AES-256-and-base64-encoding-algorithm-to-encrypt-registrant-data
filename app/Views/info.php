    ...
    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                    ...
                    <form action="<?= base_url('/addons'); ?>" method="post"
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="(Search keyword: title or category)"
                                aria-label="Search" aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword5')?>" autocomplete="off" autofocus>
                                ...
                                <?= csrf_field();?>
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small"
                                            ...
                                            aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword5')?>" autocomplete="off">
                                        <div class="input-group-append">
                                        <button class="btn btn-outline-dark" type="submit" name="search">
                                                <i class="fas fa-search fa-sm"></i>
                                            </button>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
    <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus"></i></button>
    <div align="center">
  <div class="col-sm-5">
<?php if(empty($help_info)):?>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="/picture/<?= $row['image'];?>" class="card-img-top" style="max-height: 350px; overflow:hidden;">
      <div class="card-body">
        <h5 class="card-title" style="color:black" align='center'><?= $row['title'];?>
      </h5>
      <div align='center'>
      <a href="<?= base_url('/read/index3/' . $row['id']); ?>" class="btn btn-warning btn-sm"><i class="fas fa-external-link-alt"></i></a>
    </div>
      ...
      <p class="card-text"><small class="text-muted">Date posted <?= date('F d, Y', $row['date_created']);?>
       </small></p>  
      </div>
    </div>
  </div>
...
<label class="custom-file-label" for="file"  style="color:black">Image (optional)</label>
            ...
            <?php endif;?>" name="category" >
             <option selected value="">Open this select menu</option>
                            <option value="Help Center"  style="color:black" <?= old('category') == 'Help Center' ? "selected": "" ?>>Help Center</option>
                            <option value="Information"  style="color:black" <?= old('category') == 'Information' ? "selected": "" ?>>Information</option>
                    </select>
                    <div class="invalid-feedback">
            <?php if(isset($validation)):?>
