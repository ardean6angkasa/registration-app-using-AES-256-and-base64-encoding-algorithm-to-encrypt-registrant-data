...
<body id="page-top">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    <div id="content">
      ...
      <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <form action="<?= base_url('/latihan'); ?>" method="post"
          class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
          <?= csrf_field(); ?>
          <div class="input-group">
            <input type="text" class="form-control bg-light border-0 small"
              placeholder="(Search keyword: email or description)" aria-label="Search" aria-describedby="basic-addon2"
              name="keyword" value="<?= session()->get('keyword7') ?>" autocomplete="off" autofocus>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown no-arrow d-sm-none">
            ...
            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
              ...
              <form class="form-inline mr-auto w-100 navbar-search" action="/latihan" method="post">
                <?= csrf_field(); ?>
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0 small"
                    placeholder="(Search keyword: email or description)" aria-label="Search"
                    aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword7') ?>"
                    autocomplete="off">
                  <div class="input-group-append">
                    <button class="btn btn-outline-dark" type="submit" name="search">
                      <i class="fas fa-search fa-sm"></i>
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Other trainings and certificates registration data</h6>
          </div>
          <div class="card-body">
            <a href="<?= base_url('/read/form2'); ?>">
                ...
                <tbody>
                  ...
                  <?php foreach ($pendaftaran as $row): ?>
                    <tr align="center">
                      ...
                      <td><?= $encrypter->decrypt(base64_decode($row['instansi'])); ?></td>
                      <td><?= $encrypter->decrypt(base64_decode($row['pekerjaan'])); ?></td>
                      <td><?= $encrypter->decrypt(base64_decode($row['prodi'])); ?></td>
                      <td><?= $encrypter->decrypt(base64_decode($row['telepon'])); ?></td>
                      <td><?= $row['email']; ?></td>
                      <td><img class="img-responsive img-thumbnail" src="/receipt/<?= $row['struk']; ?>" style="width:40%">
                      </td>
                      <td><?= $row['inform']; ?></td>
                      <td>
                        <a href="#" class="btn btn-warning btn-sm" data-target="#viewModal<?= $row['id']; ?>"
                          data-toggle="modal"><i class="fas fa-external-link-alt"></i></a><br><br>
                        <a href="#" class="btn btn-info btn-sm" data-target="#editModal<?= $row['id']; ?>"
                          data-toggle="modal"><i class="fas fa-edit d-inline"></i></a><br><br>
                        <a href="#" class="btn btn-danger btn-sm" data-target="#deleteModal<?= $row['id']; ?>"
                          data-toggle="modal"><i class="fas fa-trash-alt d-inline"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="color:black">Select "Sign Out" below if you are ready to end your current
          session.</div>
  ...
  <?php foreach ($pendaftaran as $row):
    $row['id']; ?>
    <form action="<?= base_url('/latihan/update') ?>" method="post">
      <div class="modal fade" id="editModal<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel2"
        ...
        <div class="modal-dialog modal-lg">
          ...
          <?php endif; ?>" name="id_number"
                      value='<?= (old('id_number')) ? old('id_number') : $encrypter->decrypt(base64_decode($row['id_number'])); ?>'
                      placeholder="">
            ...
            <?php endif; ?>" name="nama2" placeholder=""
                      value='<?= (old('nama2')) ? old('nama2') : $encrypter->decrypt(base64_decode($row['nama'])); ?>'>
            ...
            <?php endif; ?>" name="instansi" placeholder=""
                      value='<?= (old('instansi')) ? old('instansi') : $encrypter->decrypt(base64_decode($row['instansi'])); ?>'>
                    <label style="color:black">Instansi</label>
                    <div class="invalid-feedback">
                      <?php if (isset($validation)): ?>
            ...
            <?php endif; ?>" name="pekerjaan" placeholder=""
                      value='<?= (old('pekerjaan')) ? old('pekerjaan') : $encrypter->decrypt(base64_decode($row['pekerjaan'])); ?>'>
            ...
            <?php endif; ?>" name="prodi" placeholder=""
                      value='<?= (old('prodi')) ? old('prodi') : $encrypter->decrypt(base64_decode($row['prodi'])); ?>'>
            ...
            <?php endif; ?>" name="telepon" placeholder=""
                      value='<?= (old('telepon')) ? old('telepon') : $encrypter->decrypt(base64_decode($row['telepon'])); ?>'>
                  ...
                  <div class="form-floating mb-3">
                    ...
                    <input type="email" style="color:black" class="form-control" value='<?= $row['email']; ?>' name="mail"
                      readonly>
            ...
            <?php endif; ?>" name="account" placeholder=""
                      value='<?= (old('account')) ? old('account') : $encrypter->decrypt(base64_decode($row['account'])); ?>'>
            ...
            <?php endif; ?>" name="bank_name" placeholder=""
                      value='<?= (old('bank_name')) ? old('bank_name') : $encrypter->decrypt(base64_decode($row['bank_name'])); ?>'>
            ...
            <?php endif; ?>" name="nominal" placeholder=""
                      value='<?= (old('nominal')) ? old('nominal') : $encrypter->decrypt(base64_decode($row['nominal'])); ?>'>
            ...
            <?php endif; ?>" name="transaction"
                      value='<?= (old('transaction')) ? old('transaction') : $encrypter->decrypt(base64_decode($row['transaction'])); ?>'>
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" style="color:black" class="form-control <?php if (isset($validation)): ?>
            <?= ($validation->hasError('inform')) ? 'is-invalid' : ''; ?>
            <?php endif; ?>" name="inform" placeholder=""
                      value="<?= (old('inform')) ? old('inform') : $row['inform']; ?>">
                    <label style="color:black">Nama pelatihan/sertifikasi?</label>
                    <div class="invalid-feedback">
                      <?php if (isset($validation)): ?>
                        <?= $validation->getError('inform'); ?>
                      <?php endif; ?>
                    </div>
                  </div>
  ...
  <?php foreach ($pendaftaran as $row):
    $row['id']; ?>
    <div class="modal fade" id="viewModal<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel2"
      aria-hidden="true" data-backdrop="static" data-keyboard="false">
            ...
            <div class="row align-items-stretch mb-5">
              <div class="col-md-6">
                <div class="card mb-3" style="max-width: 540px;">
                  <div class="card-body">
                    <h5 class="card-title" style="color:black" align='center'>Biodata</h5>
                    <p class="card-text" style="color:black">
                      ...
                      Email: <?= $row['email']; ?><br>
                      Nomor Telepon: <?= $encrypter->decrypt(base64_decode($row['telepon'])); ?>
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <p class="card-text" style="color:black">Nama di Rekening:
                          <?= $encrypter->decrypt(base64_decode($row['account'])); ?><br>
                          Nama Bank Pentransfer: <?= $encrypter->decrypt(base64_decode($row['bank_name'])); ?><br>
                          Tanggal Transfer:
                          <?= (date('d-n-Y', strtotime($encrypter->decrypt(base64_decode($row['transaction']))))); ?><br>
  ...
  <?php foreach ($pendaftaran as $row):
    $row['id']; ?>
    <form action="<?= base_url('/latihan/delete'); ?>" method="post">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="text" style="color:black" class="form-control"
                value='<?= $encrypter->decrypt(base64_decode($row['nama'])); ?>' readonly>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="<?= base_url('/sendmsg/send2'); ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="<?= base_url('/latihan/registration'); ?>" method="POST">
            <?= csrf_field(); ?>
            <div class="form-floating mb-3">
  ...
  <div class="modal fade" id="commitDelete" aria-hidden="true" aria-labelledby="exampleDelete" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= base_url('/latihan/delete2'); ?>" method="post">
            <?= csrf_field(); ?>
  ...
  <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= base_url('/profile/editprofile2'); ?>" enctype="multipart/form-data" method="POST">
            <?= csrf_field(); ?>
            <input type="hidden" name="user_id" value="<?= session()->get('user_id') ?>">
            <div class="form-group" align="center">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer border-0">
          <form action="<?= base_url('/removephoto/remove2'); ?>" method="POST">
  ...
  <div class="modal fade" id="exampleModalToggle3" aria-hidden="true" aria-labelledby="exampleModalToggleLabel3"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= base_url('/editpass/password2'); ?>" method="POST">
            <?= csrf_field(); ?>
            <input type="hidden" name="user_id" value="<?= session()->get('user_id') ?>">
            <div class="form-floating mb-3">
              <input type="password" class="form-control <?php if (isset($validation)): ?>
