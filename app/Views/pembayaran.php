    ...
    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                    ...
                    <form action="<?= base_url('/latihan'); ?>" method="post"
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="(Search keyword: email or description)"
                                aria-label="Search" aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword7')?>" autocomplete="off" autofocus>
                                ...
                                <?= csrf_field();?>
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small"
                                            ...
                                            aria-describedby="basic-addon2" name="keyword" value="<?= session()->get('keyword7')?>" autocomplete="off">
                                        <div class="input-group-append">
                                        <button class="btn btn-outline-dark" type="submit" name="search">
                                                <i class="fas fa-search fa-sm"></i>
                                            </button>
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <td><?= $encrypter->decrypt(base64_decode($row['id_number']));?></td> 
                    ...
                    <td><?= $row['email'];?></td>
                    <td><img class="img-responsive img-thumbnail" src="/receipt/<?= $row['struk'];?>" style="width:40%"></td>
                    <td><?= $row['inform'];?></td>
                    <td>
                    <a href="#" class="btn btn-warning btn-sm" data-target="#viewModal<?= $row['id'];?>" data-toggle="modal"><i class="fas fa-external-link-alt"></i></a><br><br>
                    <a href="#" class="btn btn-info btn-sm" data-target="#editModal<?= $row['id'];?>" data-toggle="modal"><i class="fas fa-edit d-inline"></i></a><br><br>
                    <a href="#" class="btn btn-danger btn-sm" data-target="#deleteModal<?= $row['id'];?>" data-toggle="modal"><i class="fas fa-trash-alt d-inline"></i></a>
                    </td>
                </tr>
            <?php endforeach;?>
...
<?php foreach($pendaftaran as $row):$row['id'];?>
<form action="<?= base_url('/latihan/update') ?>" method="post">
        <div class="modal fade" id="editModal<?= $row['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg">
          ...
          <?php endif;?>
            ...
            <?php endif;?>" name="nama2" placeholder="" value='<?= (old('nama2')) ? old('nama2') : $encrypter->decrypt(base64_decode($row['nama']));?>'>
            ...
            <?php endif;?>" name="instansi" placeholder="" value='<?= (old('instansi')) ? old('instansi') : $encrypter->decrypt(base64_decode($row['instansi']));?>'>
            ...
            <?php endif;?>" name="pekerjaan" placeholder="" value='<?= (old('pekerjaan')) ? old('pekerjaan') : $encrypter->decrypt(base64_decode($row['pekerjaan']));?>'>
            ...
            <?php endif;?>" name="prodi" placeholder="" value='<?= (old('prodi')) ? old('prodi') : $encrypter->decrypt(base64_decode($row['prodi']));?>'>
            ...
            <?php endif;?>" name="telepon" placeholder="" value='<?= (old('telepon')) ? old('telepon') : $encrypter->decrypt(base64_decode($row['telepon']));?>'>
            ...
            <?php endif;?>
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="email" style="color:black" class="form-control" value='<?= $row['email'];?>' name="mail" readonly>
            ...
            <?php endif;?>" name="inform" placeholder="" value="<?= (old('inform')) ? old('inform') : $row['inform'];?>">
    ...
    <?php foreach($pendaftaran as $row):$row['id'];?>
        <div class="modal fade" id="viewModal<?= $row['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  ...
  <div class="row g-0">
    ...
    <div class="modal fade" id="deleteModal<?= $row['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true" data-backdrop="static" data-keyboard="false">
