  ...
  <symbol id="info-fill" fill="currentColor" viewBox="0 0 16 16">
    <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
     ...
     data-aos-duration="4000">
                ...
                <button type='button' class="btn btn-warning btn-xl text-uppercase rounded-pill" data-toggle="modal" data-target="#editSettings"><i class="fas fa-cogs fa-fw"></i> Main Menu</button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                                    ...
                                    <div align="center">
                                    <button class="btn btn-outline-success rounded-pill" data-target="#exampleModalToggle4" data-toggle="modal" data-dismiss="modal"><i class="fas fa-portrait"></i> My Profile
                                  </button>
                                    <br>
                                    <br>
                                    <button class="btn btn-outline-success rounded-pill position-relative" data-target="#exampleModalToggle10" data-toggle="modal" data-dismiss="modal"><i class="fas fa-envelope-open-text"></i> My Messages
                                    <?= session()->get('badge')?>
                                    </button>
                                    <br>
                                    <br>
                                    <button class="btn btn-outline-success rounded-pill" data-target="#exampleModalToggle3" data-toggle="modal" data-dismiss="modal"><i class="fas fa-key"></i> Change Password</button>
                                    </div>
                                    </div>
                                    <div class="modal-footer">
		<button class="btn btn-outline-dark rounded-pill" data-toggle="modal" data-dismiss="modal" data-target="#logoutModal"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> Sign Out</button>
	</div>
</div>
               ...
               <br>
                 ...
                 <?php if(empty(session()->get('tempat_tanggal_lahir'))):?>
                  ...
                  <?php else:?>
                   ...
                   <br>
                     Phone Number: <?= $encrypter->decrypt(base64_decode(session()->get('phone')));?></p>
               </div>
                                    <div class="modal-footer">
                                    <button class="btn btn-outline-success rounded-pill" data-target="#exampleModalToggle2" data-toggle="modal" data-dismiss="modal"><i class="fas fa-user-edit"></i> Edit Profile</button>
...
<div class="modal fade" id="exampleModalToggle10" aria-hidden="true" aria-labelledby="exampleModalToggleLabel10" tabindex="-1" data-backdrop="static" data-keyboard="false">
...
data-aos-duration="2000" role="alert">
      ...
      <img class="img-thumbnail rounded-circle"
						src="/img/<?= $row['photo2'];?>" style="width:6%">
     ...
     <button type="button" class="btn btn-outline-danger rounded-pill border-0 btn-delete" data-target="#deleteModal<?= $row['id'];?>" data-toggle="modal" data-dismiss='modal'><i class="fas fa-trash-alt d-inline"></i></button>
                     </p>
      ...
      <?= session()->get('name')?>
     <img class="img-thumbnail rounded-circle"
						src="/img/<?= session()->get('photo')?>" style="width:6%">   
     </p>
     ...
     <button type="submit" class="btn btn-outline-info rounded-pill border-0"><i class="fas fa-edit d-inline"></i></button>
     </form>               
                     </p>
                ...
                <?php endif;?>
                                    ...
                                    <div class="modal-footer">
                                    <button class="btn btn-outline-dark rounded-pill" type='button' data-target="#editSettings" data-toggle="modal" data-dismiss="modal">Back To Settings</button>
                                    <button class="btn btn-outline-success rounded-pill" type="submit"><i class="fas fa-paper-plane"></i> Send</button>
                    </form> 
  ...
  <br>  <br>
     <div class="custom-file">
      ...
      <div class="form-floating mb-3">
              <input type="email" name="mail" readonly class="form-control" value="<?= session()->get('email'); ?>" style="color:black">
      ...
      <?php endif;?>
          ...
          <div class="form-floating mb-3">
              <input type="text" class="form-control <?php if(isset($validation)):?>
      <?= ($validation->hasError('tempat_tanggal_lahir2'))?'is-invalid' : ''; ?>
      <?php endif;?>" name="tempat_tanggal_lahir2" value="<?= $encrypter->decrypt(base64_decode(session()->get('tempat_tanggal_lahir'))); ?>" placeholder="" style="color:black">
      <label style="color:black">Birth Place & Date</label>
              <div class="invalid-feedback">
      <?php if(isset($validation)):?>
      <?=$validation->getError('tempat_tanggal_lahir2');?>
      ...
      <?php endif;?>" name="phone2" value="<?= $encrypter->decrypt(base64_decode(session()->get('phone'))); ?>" placeholder="Phone Number" style="color:black">
...
<form action="<?= base_url('/useracc/deletemsg'); ?>" method="post">
 <?php foreach($messaging as $row):$row['id'];?>      
    <div class="modal fade" id="deleteModal<?= $row['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="btn-close"  data-target="#exampleModalToggle10" data-toggle="modal" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-dark rounded-pill" data-target="#exampleModalToggle10" data-toggle="modal" data-dismiss="modal">No</button>
...
<div class="modal-content">
	...
	<div class="modal-footer">
		<button class="btn btn-outline-dark rounded-pill" data-target="#editSettings" data-toggle="modal" data-dismiss="modal">Cancel</button>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 my-3 my-lg-0">
                        <a class="btn btn-dark btn-social mx-2" href="https://twitter.com/upj_bintaro"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/jcal.upj.9"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/jcal.upj"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </footer>
