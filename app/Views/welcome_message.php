...
<body id="page-top">
          ...
          <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total other training and
                      certificate registrant
                    </div>
  ...
  <div class="modal fade" id="exampleModalToggle5" data-backdrop="static" data-keyboard="false" aria-hidden="true"
        ...
        <div class="modal-body">
          <form action="<?= base_url('/profile'); ?>" enctype="multipart/form-data" method="POST">
            ...
            <div class="form-group" align="center">
              ...
              <img src="/img/<?= $display = session()->get('photo'); ?>" class='img-thumbnail img-preview'
                style='width:24%'>
